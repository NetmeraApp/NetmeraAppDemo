...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Netmera/AdIdSupport/NetmeraAdId.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Netmera/Application/Netmera.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/NetmeraCore/NetmeraCore.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Netmera/NotificationServiceExtension/NetmeraNotificationServiceExtension.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Netmera/NotificationContentExtension/NetmeraNotificationContentExtension.framework"
fi
